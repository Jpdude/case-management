...
namespace Project
{
    public class Student
    {
        ...
        public string Agree_Step4 { get; set; }
        public string Comments_Step4 { get; set; }
        public string If_Agree_No_Explain_Step4 { get; set; }
        public string Date_Step4 { get; set; }
        public string Dean_Name { get; set; }
        public string Agree_Step5 { get; set; }
        public string Comments_Step5 { get; set; }
